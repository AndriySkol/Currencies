...
namespace Currency_Interlogic
{
    public partial class Graph : Form, IObserver
    {
        ...
        void InitializeChart(string name, DateTime x1, DateTime x2)
        {
            ...
            if (DatabaseProxy.Data.IsReady)
            {
                var query = (from x in DatabaseProxy.Data.Currencies
        ...
        public void CreateTable(string name, DateTime x1, DateTime x2)
        {
            if (DatabaseProxy.Data.IsReady)
            {
                ...
                int searchNameID = DatabaseProxy.Data.Names.Find(b => b.name == name).ID;
        ...
        {
            var querry = (from x in DatabaseProxy.Data.DataBaseRef.Names
                          select x.name);
